...
export default function DriverLayout() {
  ...
  const menuItems = [
    { label: "Dashboard", to: "/driver", end: true },
    { label: "Trips", to: "/driver/trips" },
    { label: "Expenses", to: "/driver/expenses" },
  ];
      ...
      <div className="drawer drawer-mobile h-screen">
        ...
        <div className="drawer-content flex flex-col">
          <div className="navbar bg-base-100 shadow-2xl w-full">
            ...
            <div className="mx-2 flex-1 px-2 font-bold">Fleetly Driver</div>
        ...
        <div className="drawer-side">
          <label htmlFor="driver-drawer" className="drawer-overlay"></label>
          <Sidebar role={role} />
        </div>
