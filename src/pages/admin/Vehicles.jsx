          ...
          {loading ? (
            ...
            <DataTable
              ...
              data={vehicles.map((v) => [
                ...
                v.model,
                v.year,
                <span className={`badge ${v.status === 'active' ? 'badge-success' : v.status === 'maintenance' ? 'badge-warning' : 'badge-error'}`}>
                  {v.status}
                </span>,
        ...
        >
          <form className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-semibold">Odometer (km)</span>
                </label>
                <input
                  type="number"
                  name="odometer"
